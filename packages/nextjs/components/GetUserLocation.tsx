    ...
    return(
        <div className="space-y-4">
                     ...
                     <button
                         ...
                         disabled={loading}
                         className="w-full flex items-center justify-center space-x-3 bg-orange-glow disabled:from-gray-700 disabled:to-gray-800 text-black px-6 py-4 rounded-xl transition-all duration-300 font-medium shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                     >
                ...
                <span>{loading ? "Getting GPS location..." : "Use GPS Location"}</span>
                     ...
                     <button
                         ...
                         disabled={loading}
                         className="w-full flex items-center justify-center space-x-3 bg-slate-800 border-2 border-blue-500 hover:bg-navy-glow hover:text-white disabled:bg-gray-800 disabled:border-gray-600 text-blue-400 px-6 py-4 rounded-xl transition-all duration-300 font-medium shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                     >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
