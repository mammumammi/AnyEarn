    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-500 to-green-600 rounded-full mb-6 shadow-lg shadow-green-500/30">
            <svg className="w-10 h-10 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
            </svg>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">
            Service Marketplace
          </h1>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-black/50 backdrop-blur-xl rounded-2xl p-2 border border-green-500/20">
            <button
              onClick={() => setActiveTab('browse')}
              className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 ${
                activeTab === 'browse'
                  ? 'bg-gradient-to-r from-green-500 to-green-600 text-black shadow-lg shadow-green-500/30'
        ...
        <div className="max-w-6xl mx-auto">
          {/* Location Prompt */}
          {showLocationPrompt && (
            <div className="bg-black/50 backdrop-blur-xl rounded-3xl p-8 border border-green-500/20 mb-8">
          ...
          {/* Location Display */}
          {userLocation && (
            <div className="bg-black/50 backdrop-blur-xl rounded-3xl p-6 border border-green-500/20 mb-8">
          ...
          {activeTab === 'create' ? (
            /* Create Service Form */
            <div className="bg-black/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-green-500/20 mb-8">
              ...
              <form onSubmit={handleHostService} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 border border-green-500/30 text-white p-4 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    required
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-black/50 border border-green-500/30 text-white p-4 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent h-32 resize-none"
                    required
                  />
                </div>
                <div>
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-black px-6 py-4 rounded-xl transition-all duration-300 font-medium shadow-lg hover:shadow-green-500/30"
                >
                  Host Service
                </button>
              </form>
            ...
            /* Services List */
            <div className="bg-black/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-green-500/20">
              ...
              {(!userLocation ? services : servicesWithDistance).length === 0 ? (
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {(!userLocation ? services : servicesWithDistance).map((service) => (
                    <div key={service.id} className="bg-black/50 rounded-2xl p-6 border border-green-500/10 hover:border-green-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
                      ...
                      <div className="flex justify-between items-center mb-4">
                        <span className="text-lg font-semibold text-green-400">{service.price} ETH</span>
                      ...
                      <div className="space-y-2">
                        {service.active && !service.acceptor && account !== service.owner && (
                          <button
                            ...
                            className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-black px-4 py-2 rounded-lg transition-all duration-300 font-medium shadow-lg hover:shadow-green-500/30"
                          >
                            Accept Service
                          </button>
                        )}
                        ...
                        {service.active && service.acceptor === account && (
                          <button
                            ...
                            className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg transition-all duration-300 font-medium shadow-lg hover:shadow-blue-500/30"
                          >
                            Complete Service
                          </button>
                        )}
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <div className="bg-black/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/10 text-center">
            <div className="text-2xl font-bold text-green-400 mb-2">{services.length}</div>
